...
خاتمة
-----
إصدار v1.0.0 يمثل بداية الطريق لـ "انيز" كلغة وصف عربية موجّهة للمطوّرين. الهدف أن تكون قاعدة صلبة قابلة للتوسعة مع دورة إصدار واضحة ومهنية. إذا رغبت، أستطيع:
- إعداد ملف CHANGELOG.md لنسخة v1 تلقائيًا.
- توليد قالب Release notes جاهز لنشر v1.0.0.
- أو فتح Pull Request يتضمن تعديل __version__ وCHANGELOG وملف الإصدارات.
